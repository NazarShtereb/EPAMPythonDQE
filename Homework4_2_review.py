...
def print_decorator(func):
    """
        Many thanks for usage of decorators. I set maximum mark for this task.        
        But see the description of create_list() function in 4-1 review file
    """
...
def normalize(text_to_normalize):
    """           
        See the description of create_list() function in 4-1 review file
    """
